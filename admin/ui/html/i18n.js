...
(function () {
  ...
  var DICT = {
    ...
    es: {
      ...
      "help.ps5": "Este cartel mira si están prendidos los tres programas que hacen falta para que entre una consola. ⚠️ Pero aunque estén los tres prendidos, hoy una PS5 igual no puede entrar: Sony pide PlayStation Plus, que es una suscripción que se paga todos los meses, para jugar en línea en cualquier servidor. Eso lo decide Sony y no se arregla desde este panel.",
      ...
      "players.pathFoot": "⚠️ la PS5 igual necesita PS Plus",
      "players.pathOk": "Prendido",
      ...
      "connect.ps5Blocked": "Hoy no puede entrar. Sony pide PlayStation Plus, que es paga, para jugar en línea en cualquier servidor. No es algo que se pueda arreglar desde acá.",
    ...
    en: {
      ...
      "players.pathFoot": "⚠️ a PS5 still needs PS Plus",
      "players.pathOk": "Running",
      ...
      "connect.ps5Blocked": "It can't get in today. Sony requires PlayStation Plus, which costs money, to play online on any server. This isn't something that can be fixed from here.",
