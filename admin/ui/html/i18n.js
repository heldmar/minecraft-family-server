...
(function () {
  ...
  var DICT = {
    ...
    es: {
      ...
      "world.regenType": "Tipo de mundo",
      "world.typeNormal": "Normal",
      "world.typeFlat": "Todo plano",
      "world.typeLarge": "Biomas gigantes",
      "world.regenStructures": "Pueblos y templos",
      "world.structuresYes": "Sí, que aparezcan",
      "world.structuresNo": "No, todo salvaje",
      "world.regenPhrase": "NUEVO",
      "confirm.phraseLabel": "Escribí {word} acá abajo para confirmar",
      "help.worldType": "Normal es Minecraft de siempre: montañas, cuevas, océanos. Todo plano es una pradera lisa hasta el horizonte, sin cuevas ni minerales — está buenísimo para construir y es aburrido para explorar. Biomas gigantes es como Normal pero todo estirado: un desierto te lleva un rato largo cruzarlo. Solo se elige al crear un mundo nuevo; no se puede cambiar después.",
      "help.structures": "Los pueblos, templos, minas abandonadas y fortalezas que Minecraft dibuja solo. Si los apagás, el mundo queda 100% salvaje. Ojo con una cosa: sin fortalezas no hay portal al End, así que al End no se llega más.",
      ...
      "world.regenConfirmBody": "Tu mundo se reemplaza por uno nuevo: {type}, con {seed} y un borde de {size} bloques. Tarda unos 45 minutos. El mundo de ahora se guarda antes, así que se puede volver.",
    ...
    en: {
      ...
      "world.regenType": "World type",
      "world.typeNormal": "Normal",
      "world.typeFlat": "Completely flat",
      "world.typeLarge": "Giant biomes",
      "world.regenStructures": "Villages and temples",
      "world.structuresYes": "Yes, include them",
      "world.structuresNo": "No, pure wilderness",
      "world.regenPhrase": "NEW",
      "confirm.phraseLabel": "Type {word} below to confirm",
      "help.worldType": "Normal is Minecraft as you know it: mountains, caves, oceans. Completely flat is smooth grassland to the horizon with no caves and no ores — brilliant for building, dull for exploring. Giant biomes is like Normal but stretched: a desert takes a proper trek to cross. You only choose this when making a new world; it can't be changed afterwards.",
      "help.structures": "The villages, temples, abandoned mines and strongholds Minecraft draws for you. Turn them off and the world is completely wild. One thing to know: no strongholds means no End portal, so you can't reach the End at all.",
      ...
      "world.regenConfirmBody": "Your world is replaced by a new one: {type}, using {seed} and a border {size} blocks across. It takes about 45 minutes. The world you have now is saved first, so you can come back.",
